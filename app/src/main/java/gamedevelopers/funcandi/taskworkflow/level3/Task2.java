package gamedevelopers.funcandi.taskworkflow.level3;
        ...
        if (v.getId() == R.id.com) {
            ...
            myAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation a) {
                    ...
                    LevelCompletedDialog dialog = new LevelCompletedDialog(Task2.this, Level3.class);
        ...
        if (v.getId() == R.id.back1) {
            ...
            myAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation a) {
                    ...
                    Intent i = new Intent(Task2.this, Level3.class);
