package gamedevelopers.funcandi.taskworkflow.level5;
...
//            Toast.makeText(this, "C1", Toast.LENGTH_SHORT).show();
            ...
            myAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation a) {
                    ...
                    LevelCompletedDialog dialog = new LevelCompletedDialog(Task1.this, Level5.class);
...
//          Toast.makeText(this, "C2", Toast.LENGTH_SHORT).show();
            ...
            myAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation a) {
                    ...
                    Intent i = new Intent(Task1.this, Level5.class);
