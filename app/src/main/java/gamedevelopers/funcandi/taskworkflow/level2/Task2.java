...
public class Task2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tilte = (TextView) findViewById(R.id.text);
        ...
        if (v.getId() == R.id.com) {
            ...
            myAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation a) {
                    ...
                    LevelCompletedDialog dialog = new LevelCompletedDialog(Task2.this, Level2.class);
        ...
        if (v.getId() == R.id.back1) {
            ...
            myAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation a) {
                    ...
                    Intent i = new Intent(Task2.this, Level2.class);
