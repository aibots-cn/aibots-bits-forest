...
import gamedevelopers.funcandi.taskworkflow.Intro.model.Quiz5;
...
public class QuizActivity5 extends AppCompatActivity {
    ...
    public static final String TAG = QuizActivity5.class.getSimpleName();
    Button skip;
    int x, y, diaCount = 1;
    String[] pageText;
    String[] lessons;
