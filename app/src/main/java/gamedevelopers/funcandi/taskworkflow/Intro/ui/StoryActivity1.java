...
import gamedevelopers.funcandi.taskworkflow.Intro.PlayAgainActivity1;
import gamedevelopers.funcandi.taskworkflow.Intro.model.Page;
import gamedevelopers.funcandi.taskworkflow.Intro.model.Story2;
...
public class StoryActivity1 extends AppCompatActivity {
    ...
    public static final String TAG = StoryActivity1.class.getSimpleName();
    int x, y, diaCount = 1;
    String[] pageText;
    String[] lessons;
    int l = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i1 = new Intent(context.getApplicationContext(), PlayAgainActivity1.class);
