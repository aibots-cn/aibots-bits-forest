...
import gamedevelopers.funcandi.taskworkflow.Intro.PlayAgainActivity4;
import gamedevelopers.funcandi.taskworkflow.Intro.model.Page;
import gamedevelopers.funcandi.taskworkflow.Intro.model.Story5;
...
public class StoryActivity4 extends AppCompatActivity {

    public static final String TAG = StoryActivity4.class.getSimpleName();
    int x, y, diaCount = 1;
    String[] pageText;
    String[] lessons;
    int l = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i1 = new Intent(context.getApplicationContext(), PlayAgainActivity4.class);
