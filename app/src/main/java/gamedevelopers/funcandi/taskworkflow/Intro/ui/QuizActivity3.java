...
import gamedevelopers.funcandi.taskworkflow.Intro.model.Quiz3;
...
public class QuizActivity3 extends AppCompatActivity {
    ...
    public static final String TAG = QuizActivity3.class.getSimpleName();
    Button skip;
    int x, y, diaCount = 1;
    String[] pageText;
    String[] lessons;
