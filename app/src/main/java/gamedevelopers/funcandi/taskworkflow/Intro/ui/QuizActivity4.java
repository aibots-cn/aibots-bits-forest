...
import gamedevelopers.funcandi.taskworkflow.Intro.model.Quiz4;
...
public class QuizActivity4 extends AppCompatActivity {
    ...
    public static final String TAG = QuizActivity4.class.getSimpleName();
    Button skip;
    int x, y, diaCount = 1;
    String[] pageText;
    String[] lessons;
