...
import gamedevelopers.funcandi.taskworkflow.Intro.PlayAgainActivity3;
import gamedevelopers.funcandi.taskworkflow.Intro.model.Page;
import gamedevelopers.funcandi.taskworkflow.Intro.model.Story4;
...
public class StoryActivity3 extends AppCompatActivity {
    ...
    public static final String TAG = StoryActivity3.class.getSimpleName();
    int x, y, diaCount = 1;
    String[] pageText;
    String[] lessons;
    int l = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i1 = new Intent(context.getApplicationContext(), PlayAgainActivity3.class);
