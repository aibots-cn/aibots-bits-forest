...
import gamedevelopers.funcandi.taskworkflow.Intro.PlayAgainActivity2;
import gamedevelopers.funcandi.taskworkflow.Intro.model.Page;
import gamedevelopers.funcandi.taskworkflow.Intro.model.Story3;
...
public class StoryActivity2 extends AppCompatActivity {
    ...
    public static final String TAG = StoryActivity2.class.getSimpleName();
    int x, y, diaCount = 1;
    String[] pageText;
    String[] lessons;
    int l = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i1 = new Intent(context.getApplicationContext(), PlayAgainActivity2.class);
