...
import gamedevelopers.funcandi.taskworkflow.level4.Task2;
        ...
        if (v.getId() == R.id.task1) {
            ...
            myAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation a) {
                    ...
                    Intent i = new Intent(Level4.this, gamedevelopers.funcandi.taskworkflow.Intro.ui.StoryActivity3.class);
                    startActivity(i);
                }
            ...
            if (Level4.isCompleted1) {
                ...
                myAnim.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation a) {
                        ...
                        Intent i = new Intent(Level4.this, Task2.class);
            ...
            if (Level4.isCompleted2) {
                ...
                myAnim.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation a) {
                        ...
                        Intent i = new Intent(Level4.this, gamedevelopers.funcandi.taskworkflow.Intro.ui.QuizActivity4.class);
                        Log.e("mylog", "in level1");
                        startActivity(i);
                    }
            ...
            if (isCompleted1 && isCompleted2 && isCompleted3) {
                ...
                myAnim.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation a) {
                        ...
                        Intent i = new Intent(Level4.this, WheelActivity.class);
                        startActivity(i);
                    }
